...
let githubLink = "http://github.com/bomret/Mailbox"

// Specify more information about your project
let info =
  [ "project-name", "Mailbox"
    "project-author", "Stefan Reichel"
    "project-summary", "A mailbox type for non-blocking, asynchronous message passing."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Mailbox" ]
